...
@section('content')
    <div class="announcements-container">
        <div class="announcements-header">
            <h1><i class="fas fa-bullhorn"></i> Create New Announcement</h1>
        ...
        <div class="announcement-form-card">
            <form action="{{ route('staff.announcements.store') }}" method="POST" enctype="multipart/form-data" class="announcement-form">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="datetime-local" name="posted_at" id="posted_at" class="form-control @error('posted_at') is-invalid @enderror" value="{{ old('posted_at') ?? now()->format('Y-m-d\TH:i') }}" required>
                    @error('posted_at')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
