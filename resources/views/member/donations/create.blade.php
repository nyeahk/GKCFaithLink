                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('member.donations.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="anonymous" name="anonymous" value="1" checked>
                            <label class="form-check-label" for="anonymous">Donate as anonymous</label>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        paymentMethodSelect.addEventListener('change', function() {
            ...
            // Show/hide donor name field based on anonymous checkbox
            const anonymousCheckbox = document.getElementById('anonymous');
            const donorNameField = document.getElementById('donorNameField');
            function toggleDonorNameField() {
                donorNameField.style.display = anonymousCheckbox.checked ? 'none' : 'block';
            }
            anonymousCheckbox.addEventListener('change', toggleDonorNameField);
            toggleDonorNameField(); // Initial state
    });
</script>
@endpush